...
/// <summary>
/// A builder class for <see cref="Tuple11{T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10}"/>.
/// </summary>
...
{
    private readonly List<Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> _tuples = [];

    public Tuple11Builder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Add(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8, T9? f9, T10? f10)
    {
        _tuples.Add(new Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10));
        return this;
    }

    public Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>[] Build() => _tuples.ToArray();
}
