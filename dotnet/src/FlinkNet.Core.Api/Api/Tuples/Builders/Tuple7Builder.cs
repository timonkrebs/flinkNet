...
/// <summary>
/// A builder class for <see cref="Tuple7{T0, T1, T2, T3, T4, T5, T6}"/>.
/// </summary>
...
{
    private readonly List<Tuple7<T0, T1, T2, T3, T4, T5, T6>> _tuples = [];

    public Tuple7Builder<T0, T1, T2, T3, T4, T5, T6> Add(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6)
    {
        _tuples.Add(new Tuple7<T0, T1, T2, T3, T4, T5, T6>(f0, f1, f2, f3, f4, f5, f6));
        return this;
    }

    public Tuple7<T0, T1, T2, T3, T4, T5, T6>[] Build() => _tuples.ToArray();
}
