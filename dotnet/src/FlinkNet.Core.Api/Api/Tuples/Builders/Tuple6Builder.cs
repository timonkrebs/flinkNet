...
/// <summary>
/// A builder class for <see cref="Tuple6{T0, T1, T2, T3, T4, T5}"/>.
/// </summary>
...
{
    private readonly List<Tuple6<T0, T1, T2, T3, T4, T5>> _tuples = [];

    public Tuple6Builder<T0, T1, T2, T3, T4, T5> Add(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5)
    {
        _tuples.Add(new Tuple6<T0, T1, T2, T3, T4, T5>(f0, f1, f2, f3, f4, f5));
        return this;
    }

    public Tuple6<T0, T1, T2, T3, T4, T5>[] Build() => _tuples.ToArray();
}
