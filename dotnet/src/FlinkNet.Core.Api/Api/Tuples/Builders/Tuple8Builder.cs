...
/// <summary>
/// A builder class for <see cref="Tuple8{T0, T1, T2, T3, T4, T5, T6, T7}"/>.
/// </summary>
...
{
    private readonly List<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>> _tuples = [];

    public Tuple8Builder<T0, T1, T2, T3, T4, T5, T6, T7> Add(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7)
    {
        _tuples.Add(new Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>(f0, f1, f2, f3, f4, f5, f6, f7));
        return this;
    }

    public Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>[] Build() => _tuples.ToArray();
}
