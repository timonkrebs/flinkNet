...
/// collector.</para>
///
/// <para>Warning: If you subclass Tuple11, then be sure to either
/// <list type="bullet">
...
[Public]
public class Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : Tuple
{
    ...
    /// <param name="f9">The value for field 9</param>
    /// <param name="f10">The value for field 10</param>
    public void SetFields(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8, T9? f9, T10? f10)
    {
        F0 = f0;
        F1 = f1;
        F2 = f2;
    ...
    /// <summary>
    /// Creates a string representation of the tuple in the form (f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10), where the
    /// individual fields are the value returned by calling <see cref="object.ToString"/> on that
    /// field.
    /// </summary>
    public override string ToString() =>
        "(" + ArrayAwareToString(F0) + "," + ArrayAwareToString(F1) + "," + ArrayAwareToString(F2) + "," + ArrayAwareToString(F3) + "," + ArrayAwareToString(F4) + "," + ArrayAwareToString(F5) + "," + ArrayAwareToString(F6) + "," + ArrayAwareToString(F7) + "," + ArrayAwareToString(F8) + "," + ArrayAwareToString(F9) + "," + ArrayAwareToString(F10) + ")";
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> tuple)
        {
            return false;
        }
    ...
    public override Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Copy() => new(F0, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10);
}

/// <summary>
/// Factory for <see cref="Tuple11{T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10}"/> allowing the compiler to infer the generic type
/// arguments implicitly. For example: <c>Tuple11.Of(...)</c> instead of
/// <c>new Tuple11&lt;...&gt;(...)</c>.
/// </summary>
[Public]
public static class Tuple11
{
    /// <summary>
    ...
    /// </summary>
    public static Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Of<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8, T9? f9, T10? f10) => new(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10);
}
