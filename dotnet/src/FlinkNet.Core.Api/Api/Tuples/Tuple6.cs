...
/// collector.</para>
///
/// <para>Warning: If you subclass Tuple6, then be sure to either
/// <list type="bullet">
...
[Public]
public class Tuple6<T0, T1, T2, T3, T4, T5> : Tuple
{
    ...
    public override string ToString() =>
        "(" + ArrayAwareToString(F0) + "," + ArrayAwareToString(F1) + "," + ArrayAwareToString(F2) + "," + ArrayAwareToString(F3) + "," + ArrayAwareToString(F4) + "," + ArrayAwareToString(F5) + ")";
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Tuple6<T0, T1, T2, T3, T4, T5> tuple)
        {
            return false;
        }
    ...
    public override Tuple6<T0, T1, T2, T3, T4, T5> Copy() => new(F0, F1, F2, F3, F4, F5);
}

/// <summary>
/// Factory for <see cref="Tuple6{T0, T1, T2, T3, T4, T5}"/> allowing the compiler to infer the generic type
/// arguments implicitly. For example: <c>Tuple6.Of(...)</c> instead of
/// <c>new Tuple6&lt;...&gt;(...)</c>.
/// </summary>
[Public]
public static class Tuple6
{
    ...
    /// </summary>
    public static Tuple6<T0, T1, T2, T3, T4, T5> Of<T0, T1, T2, T3, T4, T5>(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5) => new(f0, f1, f2, f3, f4, f5);
}
