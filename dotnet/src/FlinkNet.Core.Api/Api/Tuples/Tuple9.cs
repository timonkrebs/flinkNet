...
/// collector.</para>
///
/// <para>Warning: If you subclass Tuple9, then be sure to either
/// <list type="bullet">
...
[Public]
public class Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> : Tuple
{
    ...
    /// <summary>
    /// Creates a string representation of the tuple in the form (f0, f1, f2, f3, f4, f5, f6, f7, f8), where the
    /// individual fields are the value returned by calling <see cref="object.ToString"/> on that
    /// field.
    /// </summary>
    public override string ToString() =>
        "(" + ArrayAwareToString(F0) + "," + ArrayAwareToString(F1) + "," + ArrayAwareToString(F2) + "," + ArrayAwareToString(F3) + "," + ArrayAwareToString(F4) + "," + ArrayAwareToString(F5) + "," + ArrayAwareToString(F6) + "," + ArrayAwareToString(F7) + "," + ArrayAwareToString(F8) + ")";
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> tuple)
        {
            return false;
        }
    ...
    public override Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> Copy() => new(F0, F1, F2, F3, F4, F5, F6, F7, F8);
}

/// <summary>
/// Factory for <see cref="Tuple9{T0, T1, T2, T3, T4, T5, T6, T7, T8}"/> allowing the compiler to infer the generic type
/// arguments implicitly. For example: <c>Tuple9.Of(...)</c> instead of
/// <c>new Tuple9&lt;...&gt;(...)</c>.
/// </summary>
[Public]
public static class Tuple9
{
    ...
    /// </summary>
    public static Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> Of<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8) => new(f0, f1, f2, f3, f4, f5, f6, f7, f8);
}
