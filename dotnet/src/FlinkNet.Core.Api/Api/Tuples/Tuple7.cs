...
/// collector.</para>
///
/// <para>Warning: If you subclass Tuple7, then be sure to either
/// <list type="bullet">
...
[Public]
public class Tuple7<T0, T1, T2, T3, T4, T5, T6> : Tuple
{
    ...
    /// <summary>
    /// Creates a string representation of the tuple in the form (f0, f1, f2, f3, f4, f5, f6), where the
    /// individual fields are the value returned by calling <see cref="object.ToString"/> on that
    /// field.
    /// </summary>
    public override string ToString() =>
        "(" + ArrayAwareToString(F0) + "," + ArrayAwareToString(F1) + "," + ArrayAwareToString(F2) + "," + ArrayAwareToString(F3) + "," + ArrayAwareToString(F4) + "," + ArrayAwareToString(F5) + "," + ArrayAwareToString(F6) + ")";
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Tuple7<T0, T1, T2, T3, T4, T5, T6> tuple)
        {
            return false;
        }
    ...
    public override Tuple7<T0, T1, T2, T3, T4, T5, T6> Copy() => new(F0, F1, F2, F3, F4, F5, F6);
}

/// <summary>
/// Factory for <see cref="Tuple7{T0, T1, T2, T3, T4, T5, T6}"/> allowing the compiler to infer the generic type
/// arguments implicitly. For example: <c>Tuple7.Of(...)</c> instead of
/// <c>new Tuple7&lt;...&gt;(...)</c>.
/// </summary>
[Public]
public static class Tuple7
{
    ...
    /// </summary>
    public static Tuple7<T0, T1, T2, T3, T4, T5, T6> Of<T0, T1, T2, T3, T4, T5, T6>(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6) => new(f0, f1, f2, f3, f4, f5, f6);
}
