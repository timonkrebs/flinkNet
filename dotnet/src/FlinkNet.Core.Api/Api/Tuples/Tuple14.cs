...
/// collector.</para>
///
/// <para>Warning: If you subclass Tuple14, then be sure to either
/// <list type="bullet">
...
[Public]
public class Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : Tuple
{
    ...
    public Tuple14(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8, T9? f9, T10? f10, T11? f11, T12? f12, T13? f13)
    {
        F0 = f0;
        F1 = f1;
        F2 = f2;
    ...
    /// <param name="f12">The value for field 12</param>
    /// <param name="f13">The value for field 13</param>
    public void SetFields(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8, T9? f9, T10? f10, T11? f11, T12? f12, T13? f13)
    {
        F0 = f0;
        F1 = f1;
        F2 = f2;
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> tuple)
        {
            return false;
        }
    ...
    public override Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Copy() => new(F0, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12, F13);
}

/// <summary>
/// Factory for <see cref="Tuple14{T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13}"/> allowing the compiler to infer the generic type
/// arguments implicitly. For example: <c>Tuple14.Of(...)</c> instead of
/// <c>new Tuple14&lt;...&gt;(...)</c>.
/// </summary>
[Public]
public static class Tuple14
{
    /// <summary>
    ...
    /// </summary>
    public static Tuple14<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Of<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8, T9? f9, T10? f10, T11? f11, T12? f12, T13? f13) => new(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13);
}
