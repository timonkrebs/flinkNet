...
/// collector.</para>
///
/// <para>Warning: If you subclass Tuple10, then be sure to either
/// <list type="bullet">
...
[Public]
public class Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : Tuple
{
    ...
    /// <summary>
    /// Creates a string representation of the tuple in the form (f0, f1, f2, f3, f4, f5, f6, f7, f8, f9), where the
    /// individual fields are the value returned by calling <see cref="object.ToString"/> on that
    /// field.
    /// </summary>
    public override string ToString() =>
        "(" + ArrayAwareToString(F0) + "," + ArrayAwareToString(F1) + "," + ArrayAwareToString(F2) + "," + ArrayAwareToString(F3) + "," + ArrayAwareToString(F4) + "," + ArrayAwareToString(F5) + "," + ArrayAwareToString(F6) + "," + ArrayAwareToString(F7) + "," + ArrayAwareToString(F8) + "," + ArrayAwareToString(F9) + ")";
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple)
        {
            return false;
        }
    ...
    public override Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> Copy() => new(F0, F1, F2, F3, F4, F5, F6, F7, F8, F9);
}

/// <summary>
/// Factory for <see cref="Tuple10{T0, T1, T2, T3, T4, T5, T6, T7, T8, T9}"/> allowing the compiler to infer the generic type
/// arguments implicitly. For example: <c>Tuple10.Of(...)</c> instead of
/// <c>new Tuple10&lt;...&gt;(...)</c>.
/// </summary>
[Public]
public static class Tuple10
{
    /// <summary>
    ...
    /// </summary>
    public static Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> Of<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4, T5? f5, T6? f6, T7? f7, T8? f8, T9? f9) => new(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9);
}
