...
/// collector.</para>
///
/// <para>Warning: If you subclass Tuple5, then be sure to either
/// <list type="bullet">
...
[Public]
public class Tuple5<T0, T1, T2, T3, T4> : Tuple
{
    ...
    public override string ToString() =>
        "(" + ArrayAwareToString(F0) + "," + ArrayAwareToString(F1) + "," + ArrayAwareToString(F2) + "," + ArrayAwareToString(F3) + "," + ArrayAwareToString(F4) + ")";
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Tuple5<T0, T1, T2, T3, T4> tuple)
        {
            return false;
        }
    ...
    public override Tuple5<T0, T1, T2, T3, T4> Copy() => new(F0, F1, F2, F3, F4);
}

/// <summary>
/// Factory for <see cref="Tuple5{T0, T1, T2, T3, T4}"/> allowing the compiler to infer the generic type
/// arguments implicitly. For example: <c>Tuple5.Of(...)</c> instead of
/// <c>new Tuple5&lt;...&gt;(...)</c>.
/// </summary>
[Public]
public static class Tuple5
{
    ...
    /// </summary>
    public static Tuple5<T0, T1, T2, T3, T4> Of<T0, T1, T2, T3, T4>(T0? f0, T1? f1, T2? f2, T3? f3, T4? f4) => new(f0, f1, f2, f3, f4);
}
