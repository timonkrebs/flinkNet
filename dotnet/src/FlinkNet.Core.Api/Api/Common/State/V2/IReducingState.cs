...
/// <summary>
/// <see cref="IState"/> interface for reducing state. Elements can be added to the state, they
/// will be combined using a reduce function. The current state can be inspected.
...
[Experimental]
public interface IReducingState<T> : IMergingState<T, T, T>
{
}
