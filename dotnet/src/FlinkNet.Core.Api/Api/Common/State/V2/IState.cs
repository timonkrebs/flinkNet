...
{
    /// <summary>Removes the value mapped under the current key asynchronously.</summary>
    IStateFuture<object?> AsyncClear();

    /// <summary>Removes the value mapped under the current key.</summary>
    void Clear();
}
