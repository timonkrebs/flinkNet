...
/// <summary>A function to be applied to all partitions.</summary>
[Experimental]
public interface IApplyPartitionFunction<TOut> : IFunction
{
    /// <summary>The actual method to be applied to each partition.</summary>
    /// <param name="collector">to output data.</param>
    /// <param name="ctx">runtime context in which this function is executed.</param>
    void Apply(ICollector<TOut> collector, IPartitionedContext<TOut> ctx);
}
