...
/// <summary>A type of <see cref="IWindowProcessFunction"/> for two-output window processing.</summary>
[Experimental]
public interface ITwoOutputWindowStreamProcessFunction<TIn, TOut1, TOut2> : IWindowProcessFunction
{
    /// <summary>
