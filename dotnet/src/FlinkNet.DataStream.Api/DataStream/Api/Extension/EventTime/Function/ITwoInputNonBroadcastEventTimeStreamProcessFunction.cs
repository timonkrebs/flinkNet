...
/// <summary>The <see cref="ITwoInputNonBroadcastStreamProcessFunction{TIn1,TIn2,TOut}"/> that
/// extends with event time support.</summary>
[Experimental]
public interface ITwoInputNonBroadcastEventTimeStreamProcessFunction<in TIn1, in TIn2, TOut>
    : IEventTimeProcessFunction, ITwoInputNonBroadcastStreamProcessFunction<TIn1, TIn2, TOut>
{
