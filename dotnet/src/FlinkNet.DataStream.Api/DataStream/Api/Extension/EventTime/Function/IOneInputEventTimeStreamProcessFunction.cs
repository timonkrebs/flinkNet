...
/// <summary>The <see cref="IOneInputStreamProcessFunction{TIn,TOut}"/> that extends with event
/// time support.</summary>
[Experimental]
public interface IOneInputEventTimeStreamProcessFunction<in TIn, TOut>
    : IEventTimeProcessFunction, IOneInputStreamProcessFunction<TIn, TOut>
{
