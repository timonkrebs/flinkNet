...
/// <summary>Type serializer for <see cref="bool"/>.</summary>
[Internal]
public sealed class BooleanSerializer : TypeSerializerSingleton<bool>
{
    /// <summary>Sharable instance of the BooleanSerializer.</summary>
    ...
    public override bool Deserialize(IDataInputView source) => source.ReadBoolean();

    public override bool Deserialize(bool reuse, IDataInputView source) =>
        Deserialize(source);
