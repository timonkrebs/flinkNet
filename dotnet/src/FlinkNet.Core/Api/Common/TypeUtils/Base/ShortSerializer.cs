...
/// <summary>Type serializer for <see cref="short"/>.</summary>
[Internal]
public sealed class ShortSerializer : TypeSerializerSingleton<short>
{
    /// <summary>Sharable instance of the ShortSerializer.</summary>
    public static readonly ShortSerializer Instance = new();

    public override bool IsImmutableType => true;

    public override short CreateInstance() => 0;
    ...
    public override short Deserialize(short reuse, IDataInputView source) =>
        Deserialize(source);
